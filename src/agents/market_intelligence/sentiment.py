...
from ...data.schemas import AgentRole, SentimentReport, Sentiment
        ...
        try:
            ...
            for item in news_items:
                ...
                meaningful_words = [
                    ...
                    if len(w) > 4 and w not in ['about', 'after', 'before', 'their', 'these', 'those']
                ]
...
"""
            ...
            try:
                ...
                retail_pos = parsed.get("retail_positioning", "Mixed sentiment among retail investors")
