...
class TestEnums:
    ...
    def test_sentiment_enum(self):
        ...
        assert len([s for s in Sentiment]) == 5
    ...
    def test_strategy_type_enum(self):
        ...
        assert len([s for s in StrategyType]) == 10
...
class TestExecutionPlan:
    ...
    def test_valid_plan(self):
        ...
        orders = [
            Order(symbol="AAPL", side=OrderSide.BUY, quantity=100, order_type=OrderType.LIMIT, price=150.00),
            Order(symbol="AAPL", side=OrderSide.SELL, quantity=1, order_type=OrderType.LIMIT, 
                  price=3.50, expiry="2024-02-16", strike=155.0, option_type="call"),
        ]
